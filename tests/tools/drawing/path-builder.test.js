...
import { PathBuilder, createPathBuilder, } from '@tools/drawing/path-builder';
describe('PathBuilder', () => {
    ...
    describe('addAnchor', () => {
        ...
        it('adds anchor with handles', () => {
            builder.addAnchor({ x: 100, y: 100 }, { x: 80, y: 100 }, // handleIn
...
//# sourceMappingURL=path-builder.test.js.map