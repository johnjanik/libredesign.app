...
import type { PolygonData } from '@tools/drawing/polygon-tool';
...
const createMockContext = (): ToolContext => ({
  ...
  viewport: {
    getZoom: () => 1,
    getViewProjectionMatrix: () => [1, 0, 0, 1, 0, 0] as any,
  } as any,
  selectedNodeIds: [],
  hoveredNodeId: null,
});
...
describe('PolygonTool', () => {
  ...
  describe('render', () => {
    it('renders preview polygon', () => {
      ...
      tool.render(mockCtx as any, context);
