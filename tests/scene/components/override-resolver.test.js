...
import { createOverrideResolver, OverridePath, } from '@scene/components/override-resolver';
...
describe('OverrideResolver', () => {
    ...
    describe('applyOverrides', () => {
        ...
        it('creates intermediate objects for deep paths', () => {
            ...
            expect(pluginData['myPlugin']?.setting).toBe('value');
        });
    });
    ...
    describe('computeOverrides', () => {
        ...
        it('skips structural properties', () => {
            ...
            const modified = { ...base, id: 'different-id' };
            const overrides = resolver.computeOverrides(base, modified);
...
//# sourceMappingURL=override-resolver.test.js.map