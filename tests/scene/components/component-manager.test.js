...
import { createComponentManager, } from '@scene/components/component-manager';
describe('ComponentManager', () => {
    ...
    describe('component creation', () => {
        ...
        describe('createComponentFromNode', () => {
            ...
            it('returns null for non-existent node', () => {
                const result = manager.createComponentFromNode('non-existent');
    ...
    describe('instance creation', () => {
        ...
        it('creates an instance of a component', () => {
            ...
            const node = sceneGraph.getNode(instanceId);
