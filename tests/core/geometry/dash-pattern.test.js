...
import { applyDashPattern, pathLength, pointAtLength, tangentAtLength, } from '../../../src/core/geometry/dash-pattern';
...
function createSquarePath(x, y, size) {
    return {
        windingRule: 'NONZERO',
        commands: [
            { type: 'M', x: x, y: y },
...
//# sourceMappingURL=dash-pattern.test.js.map