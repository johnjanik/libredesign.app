...
import { GradientRenderer, createGradientRenderer, createLinearGradient, createRadialGradient, createAngularGradient, createDiamondGradient, createGradientStop, createGradientStopsFromColors, } from '@renderer/paint/gradient-renderer';
// Mock WebGL context
...
describe('GradientRenderer', () => {
    ...
    beforeEach(() => {
        ...
        renderer = new GradientRenderer(ctx, shaders);
    });
    ...
    describe('setupGradient', () => {
        ...
        const transform = [2, 0, 0, 2, 100, 100];
...
describe('createGradientRenderer', () => {
    it('creates a gradient renderer', () => {
        ...
        const renderer = createGradientRenderer(ctx, shaders);
...
describe('createGradientStopsFromColors', () => {
    ...
    it('uses custom positions', () => {
        const stops = createGradientStopsFromColors(['#ff0000', '#00ff00', '#0000ff'], [0, 0.25, 1]);
        expect(stops[0].position).toBe(0);
...
//# sourceMappingURL=gradient-renderer.test.js.map