...
import type { DropShadowConfig } from '@renderer/effects/drop-shadow-effect';
...
const defaultShadowConfig: DropShadowConfig = {
...
describe('DropShadowEffectRenderer', () => {
  ...
  let renderer: DropShadowEffectRenderer;
