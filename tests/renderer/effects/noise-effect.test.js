...
import { noise, isNoiseEffect, } from '@core/types/effect';
...
describe('NoiseEffectConfig', () => {
    it('should detect noop configurations', () => {
        ...
        const isNoop = (config) => config.amount < 0.1;
...
//# sourceMappingURL=noise-effect.test.js.map