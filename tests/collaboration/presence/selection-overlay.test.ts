...
import type {
  ...
  NodeBounds,
  NodeBoundsProvider
} from '@collaboration/presence/selection-overlay';
...
const createMockBoundsProvider = (
  bounds: Map<string, NodeBounds> = new Map()
): NodeBoundsProvider => ({
  getNodeBounds: vi.fn((nodeId: NodeId) => {
...
describe('SelectionOverlay', () => {
  ...
  let boundsProvider: NodeBoundsProvider;
  ...
  describe('initialization', () => {
    ...
    it('overlay has correct styles', () => {
      const overlayEl = container.querySelector('.selection-overlay') as HTMLElement;
  ...
  describe('updateSelection', () => {
    it('creates selection container for client', () => {
      const data: SelectionDisplayData = {
        clientId: 'user1',
    ...
    it('applies color to selection rectangles', () => {
      ...
      const rect = container.querySelector('.selection-rect') as HTMLElement;
  ...
  describe('refreshAllSelections', () => {
    it('updates all rectangle positions', () => {
      ...
      (boundsProvider.getNodeBounds as ReturnType<typeof vi.fn>).mockReturnValue({
