...
import type { CursorDisplayData } from '@collaboration/presence/cursor-overlay';
...
describe('CursorOverlay', () => {
  ...
  describe('initialization', () => {
    ...
    it('overlay has correct styles', () => {
      const overlayEl = container.querySelector('.cursor-overlay') as HTMLElement;
  ...
  describe('updateCursor', () => {
    ...
    it('applies user color to label', () => {
      ...
      const label = container.querySelector('.cursor-label') as HTMLElement;
    ...
    it('updates existing cursor position', () => {
      ...
      expect(overlay.getCursorCount()).toBe(1);
      const cursorEl = container.querySelector('.remote-cursor') as HTMLElement;
