...
export interface RenderTargetConfig {
  ...
  readonly format?: number;      // GL internal format (default: RGBA8)
  readonly filter?: number;      // GL texture filter (default: LINEAR)
  readonly wrap?: number;        // GL wrap mode (default: CLAMP_TO_EDGE)
 ...
 */
export function createCanvasSizedRenderTarget(ctx: WebGLContext): RenderTarget {
