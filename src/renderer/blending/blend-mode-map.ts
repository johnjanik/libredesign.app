 ...
 */
export function getBlendFactors(gl: WebGL2RenderingContext, mode: BlendMode): BlendFactors | null {
  switch (mode) {
    case 'PASS_THROUGH':
    case 'NORMAL':
 ...
 */
export function requiresShaderBlend(mode: BlendMode): boolean {
  switch (mode) {
    case 'OVERLAY':
    case 'SOFT_LIGHT':
    case 'HARD_LIGHT':
 ...
 */
export function getBlendModeGLSL(mode: BlendMode): string {
  switch (mode) {
    case 'OVERLAY':
      return `
 ...
 */
export function applyBlendFactors(
 ...
 */
export function setNormalBlending(gl: WebGL2RenderingContext): void {
