 ...
 */
import { GRADIENT_VERTEX_SHADER, LINEAR_GRADIENT_FRAGMENT_SHADER, RADIAL_GRADIENT_FRAGMENT_SHADER, ANGULAR_GRADIENT_FRAGMENT_SHADER, DIAMOND_GRADIENT_FRAGMENT_SHADER, } from './gradient.glsl';
import { COLOR_ADJUSTMENT_VERTEX_SHADER, COLOR_ADJUSTMENT_FRAGMENT_SHADER, } from './color-adjustment.glsl';
import { NOISE_VERTEX_SHADER, NOISE_FRAGMENT_SHADER, } from './noise.glsl';
import { MOTION_BLUR_VERTEX_SHADER, MOTION_BLUR_FRAGMENT_SHADER, MOTION_BLUR_HQ_FRAGMENT_SHADER, } from './motion-blur.glsl';
/**
 ...
 */
export function createShaderManager(ctx) {
