 ...
 * Operation types
 */
export type OperationType = 'INSERT_NODE' | 'DELETE_NODE' | 'SET_PROPERTY' | 'MOVE_NODE' | 'REORDER_NODE';
/**
 ...
 */
export type Operation = InsertNodeOperation | DeleteNodeOperation | SetPropertyOperation | MoveNodeOperation | ReorderNodeOperation;
/**
 * Compare Lamport timestamps.
 * Returns negative if a < b, positive if a > b, 0 if equal.
 */
export declare function compareTimestamps(a: LamportTimestamp, b: LamportTimestamp): number;
/**
 * Create a new Lamport timestamp.
 */
export declare function createTimestamp(counter: number, clientId: string): LamportTimestamp;
/**
 * Increment a Lamport timestamp.
 */
export declare function incrementTimestamp(ts: LamportTimestamp): LamportTimestamp;
/**
 * Merge timestamps (for receiving remote operations).
 */
export declare function mergeTimestamps(local: LamportTimestamp, remote: LamportTimestamp): LamportTimestamp;
/**
 * Generate a unique operation ID.
 */
export declare function generateOperationId(clientId: string): string;
