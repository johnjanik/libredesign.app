 ...
 * Message types
 */
export type MessageType = 'HELLO' | 'HELLO_ACK' | 'SYNC_REQUEST' | 'SYNC_RESPONSE' | 'OPERATION' | 'OPERATION_ACK' | 'PRESENCE' | 'ERROR' | 'PING' | 'PONG';
/**
 ...
 * Error codes
 */
export type ErrorCode = 'INVALID_MESSAGE' | 'DOCUMENT_NOT_FOUND' | 'UNAUTHORIZED' | 'RATE_LIMITED' | 'INTERNAL_ERROR';
/**
 ...
 */
export type SyncMessage = HelloMessage | HelloAckMessage | SyncRequestMessage | SyncResponseMessage | OperationMessage | OperationAckMessage | PresenceMessage | ErrorMessage | PingMessage | PongMessage;
/**
 * Serialize a message to JSON.
 */
export declare function serializeMessage(message: SyncMessage): string;
/**
 * Deserialize a message from JSON.
 */
export declare function deserializeMessage(data: string): SyncMessage;
/**
 * Create a HELLO message.
 */
export declare function createHelloMessage(clientId: string, documentId: string, userName: string, version?: string): HelloMessage;
/**
 * Create an OPERATION message.
 */
export declare function createOperationMessage(operation: Operation): OperationMessage;
/**
 * Create a PRESENCE message.
 */
export declare function createPresenceMessage(clientId: string, presence: Partial<PresenceData>): PresenceMessage;
/**
 * Create a SYNC_REQUEST message.
 */
export declare function createSyncRequestMessage(since: LamportTimestamp | null): SyncRequestMessage;
/**
 * Create an ERROR message.
 */
export declare function createErrorMessage(code: ErrorCode, message: string, details?: unknown): ErrorMessage;
