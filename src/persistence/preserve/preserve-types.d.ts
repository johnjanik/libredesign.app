...
export declare const PRESERVE_MIMETYPE = "application/vnd.designlibre.preserve+zip";
export declare const PRESERVE_EXTENSION = ".preserve";
export declare const PRESERVE_FORMAT_VERSION = "1.0.0";
...
export type PreserveNode = PreserveFrameNode | PreserveVectorNode | PreserveTextNode | PreserveImageNode | PreserveComponentNode | PreserveInstanceNode | PreserveBooleanNode | PreserveSliceNode;
...
export type PreserveToken = PreserveColorToken | PreserveTypographyToken | PreserveSpacingToken | PreserveShadowToken | PreserveRadiusToken;
...
//# sourceMappingURL=preserve-types.d.ts.map