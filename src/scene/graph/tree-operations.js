...
const VALID_CHILDREN = {
    DOCUMENT: ['PAGE'],
    PAGE: ['FRAME', 'GROUP', 'VECTOR', 'TEXT', 'COMPONENT', 'INSTANCE', 'BOOLEAN_OPERATION', 'SLICE'],
    FRAME: ['FRAME', 'GROUP', 'VECTOR', 'TEXT', 'COMPONENT', 'INSTANCE', 'BOOLEAN_OPERATION', 'SLICE'],
    GROUP: ['FRAME', 'GROUP', 'VECTOR', 'TEXT', 'COMPONENT', 'INSTANCE', 'BOOLEAN_OPERATION', 'SLICE'],
    VECTOR: [],
    TEXT: [],
    COMPONENT: ['FRAME', 'GROUP', 'VECTOR', 'TEXT', 'INSTANCE', 'BOOLEAN_OPERATION'],
    INSTANCE: [],
