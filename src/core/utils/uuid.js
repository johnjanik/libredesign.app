...
export function generateUUID() {
    ...
    const part4 = (0x80 | (r2 & 0x3f)).toString(16).padStart(2, '0') +
        r3.toString(16).padStart(2, '0');
    const part5 = r4.toString(16).padStart(2, '0') +
...
export function compareUUIDs(a, b) {
