...
export function lineBezierIntersection(
  ...
  lineBezierIntersectionRecursive(
    lineStart,
    lineEnd,
    p0,
    p1,
...
function lineBezierIntersectionRecursive(
  lineStart: Point,
  lineEnd: Point,
  p0: Point,
  p1: Point,
  ...
  if (
    curveBounds.maxX < lineBounds.minX ||
 ...
 */
export function bezierBezierIntersection(
  a0: Point,
  a1: Point,
  a2: Point,
  a3: Point,
  ...
  const results: IntersectionResult[] = [];
  bezierBezierIntersectionRecursive(
    a0,
    a1,
    a2,
    a3,
...
function bezierBezierIntersectionRecursive(
  a0: Point,
  a1: Point,
  a2: Point,
  a3: Point,
  ...
  if (
    aBounds.maxX < bBounds.minX - tolerance ||
...
function deduplicateIntersections(
  ...
  for (const intersection of intersections) {
    const isDuplicate = result.some(
      (existing) =>
        Math.abs(existing.t1 - intersection.t1) < tolerance &&
