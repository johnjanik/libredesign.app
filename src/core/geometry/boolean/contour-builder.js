 ...
 */
export function extractContours(subject, clip, operation) {
    const results = [];
    // Reset visited flags
 ...
 */
function hasAnyIntersections(polygon) {
 ...
 */
function findUnvisitedEntryIntersection(subject, clip) {
 ...
 */
function extractSingleContour(start) {
    const points = [];
    let current = start;
 ...
 */
function handleNoIntersections(subject, clip, operation) {
 ...
 */
export function extractContoursAlternative(subject, clip, operation) {
    const results = [];
    subject.resetVisited();
    clip.resetVisited();
 ...
 */
function findUnvisitedIntersection(subject, clip) {
    for (const v of subject.unvisitedIntersections()) {
        return v;
    }
    for (const v of clip.unvisitedIntersections()) {
 ...
 */
function extractContourByDirection(start, operation) {
    const points = [];
    let current = start;
    let maxSteps = 10000;
...
//# sourceMappingURL=contour-builder.js.map