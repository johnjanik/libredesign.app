...
export function cubicBezierLength(p0, p1, p2, p3, segments = 10) {
    let length = 0;
    let prevPoint = p0;
 ...
 */
function findCubicExtrema(p0, p1, p2, p3) {
...
export function sampleCubicBezier(p0, p1, p2, p3, numSamples) {
    const points = [];
 ...
 */
export function cubicBezierNearestT(p0, p1, p2, p3, target, iterations = 5) {
