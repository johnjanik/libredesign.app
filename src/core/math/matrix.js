...
export function matricesEqual(a, b, tolerance = 1e-6) {
    for (let i = 0; i < 6; i++) {
...
export function isIdentity(m, tolerance = 1e-6) {
...
export function compose(tx, ty, rotation, scaleX, scaleY) {
...
export function toCSSTransform(m) {
