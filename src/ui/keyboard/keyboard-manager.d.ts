...
export declare class KeyboardManager {
    ...
    private actionGroup;
    private actionUngroup;
    private actionZoomTo100;
    private actionZoomToFit;
    private actionZoomToSelection;
    private actionZoomIn;
    private actionZoomOut;
    private actionSetTool;
    private actionNudge;
    private actionResize;
    private actionBringForward;
    private actionSendBackward;
    private actionBringToFront;
    private actionSendToBack;
    ...
    private actionToggleLock;
    private actionToggleVisibility;
