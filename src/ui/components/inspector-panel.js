 ...
 */
import { extractProperties, extractSharedProperties, } from '@devtools/inspection/property-extractor';
...
export class InspectorPanel {
    ...
    `;
      ...
      `;
        ...
        // Property sections
        const categories = ['transform', 'appearance', 'layout', 'typography', 'effects'];
    ...
    createPropertySection(category, properties) {
    ...
    createReadOnlyValue(prop, container) {
    ...
    createEditableValue(prop, container) {
    ...
    createNumberInput(prop, container, nodeId) {
    ...
    createColorInput(prop, container, nodeId) {
    ...
    createBooleanInput(prop, container, nodeId) {
    ...
    createStringInput(prop, container, nodeId) {
        const input = document.createElement('input');
        input.type = 'text';
        input.value = String(prop.value);
        input.style.cssText = `
    ...
    createEnumInput(prop, container, nodeId) {
    ...
    updateNodeColor(nodeId, propName, color) {
        const sceneGraph = this.runtime.getSceneGraph();
